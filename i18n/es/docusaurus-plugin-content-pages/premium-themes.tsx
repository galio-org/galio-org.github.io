...
import GalioExamples from "@site/src/components/GalioExamples";
import { useTranslations } from "@site/src/hooks/useTranslations";
import CarbonAds from "@site/src/components/CarbonAds";
import GalioPremium from "@site/src/components/GalioPremium";
            ...
            <main className="flex flex-col items-center justify-center">
                <div className="lg:w-[53%] pt-15">
                    <div className="flex flex-col items-center justify-center">
                        <p className="text-2xl md:text-5xl text-center">{t('premiumThemes.explore')}</p>
                    </div>
