...
sidebar_position: 1
title: Introduction
description: Galio is a free and open-source React Native framework that provides a set of pre-designed components and themes to help developers build mobile applications quickly and efficiently.
---
